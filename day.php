		...
		<div class="holder">
			<div class="day-slider">
				...
				<a href="">
					<div class="day-selector">
						<p class="day">22</p>
						<p class="week-day">M</p>
					</div>
				</a>
				<a href="">
					<div class="day-selector">
						<p class="day">23</p>
						<p class="week-day">T</p>
					</div>
				</a>
				<a href="">
					<div class="day-selector">
						<p class="day">24</p>
						<p class="week-day">W</p>
					</div>
				</a>
				<a href="">
			...
			<div class="table-day">
				...
				<div class="entries">
					...
					<input class="entry" type="text" name="le1" value="1. ">
					<input class="entry" type="text" name="le2" value="2. ">
					<input class="entry" type="text" name="le3" value="3. ">
